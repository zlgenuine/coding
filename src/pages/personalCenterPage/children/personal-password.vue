...
<div class="personal-password">
  <div class="personal-password-wrap personal-form">
    ...
    <input type="password" name="password" id="password" placeholder="请输入账户原密码" autocomplete="new-password" v-model="param.userPasswd" />
  </div>
  <div class="personal-password-wrap personal-form">
    <label for="passwordNew">新密码</label>
    <input type="password" name="passwordNew" id="passwordNew" placeholder="请输入新密码" autocomplete="new-password" v-model="param.newPasswd" />
  </div>
  <div class="personal-password-wrap personal-form">
    <label for="passwordNew1">确认密码</label>
    <input type="password" name="passwordNew1" id="passwordNew1" placeholder="请确认新密码" autocomplete="new-password" v-model="param.newPasswd1" />
  </div>
