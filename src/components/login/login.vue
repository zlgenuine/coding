        ...
        <div class="login-content">
            ...
            <div class="login-body">
                <div class="login-main" v-if="showLogin">
                    <div class="input-wrapper">
                        <div class="input-phone" :class="{warn: telTip}">
                            ...
                            <input class="input" autocomplete="off" type="text" placeholder="请输入手机号码" maxlength="11"
                                   v-model="userData.userMobile" @input="userMobileIpt" @blur="checkTel">
                        </div>
                        <div class="input-password" :class="{warn: passwordTip}">
                            ...
                            <input class="input" autocomplete="off" type="password" maxlength="16" placeholder="请输入密码"
                                   v-model="userData.userPWD" @input="userPWDIpt" @blur="checkPWD"
                ...
                <div class="download-main" v-if="!showLogin">
                    <ts-image src="/static/images/qrcode/app.png" width="300" height="300" :canView="false"
    ...
    data () {
      return {
        ...
        userData: {
          ...
          userPWD: '',
          picCode: '',
          webSiteType: '1'  // 当前登录平台 1-ts57 2-蕾丝控
        },
        showLogin: true
      };
    },
