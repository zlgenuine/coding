  ...
  <ts-section pageTitle="企业信息" class="companyIntro-section">
    <div class="grid-row-fluid">
      ...
      {{companyInfo.companyName}}&nbsp;&nbsp;&nbsp;
        <ts-button v-if="getCanCollect" type="plain" style="border-radius: 4px;" class="companyIntro-companyName--button" @click="handleCollectStore">
    ...
    <div class="companyIntro-manage grid-row-table">
      <div class="grid-row-table-row">
          ...
          <div class="grid-col-tab-3 is-content">
            {{companyExtendBO.registeredMoney}}
...
export default {
  ...
  created() {
  if (this.companyInfo.lng && this.companyInfo.lat) {
  ...
  computed: {
    ...mapGetters(['companyInfo', 'userInfo', 'search']),
    // 收藏状态 0未收藏 1已收藏
    getIsCollect() {
  ...
  methods: {
    ...
    async index() {
      if (!this.isShop) {
        this.companyInfo = this.search.info;
      }
